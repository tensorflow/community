...
| Status        | Proposed                                                     |
| :------------ | :----------------------------------------------------------- |
| **Author(s)** | Ruoyu Liu (ruoyu@google.com), Hui Miao (huimiao@google.com), |
:               : Hongye Sun (hongyes@google.com), Renmin Gu                   :
:               : (renming@google.com)                                         :
| **Sponsor**   | Konstantinos Katsiapis (katsiapis@google.com), Mitch Trott   |
:               : (trott@google.com), Zhitao Li (zhitaoli@google.com)          :
| **Updated**   | 2020-07-05                                                   |
...
## Background and Motivation {.numbered}

### The importance of a uniform data model {.numbered}
...
### The importance of a consistent data model across platforms {.numbered}
...
### Motivation of the intermediate representation {.numbered}
...
#### Data model of a Channel {.numbered}
...
##### Consistent for both data modes {.numbered}
...
##### Consistent for all platforms {.numbered}
...
##### Consistent for all features {.numbered}
...
#### Data model in advanced semantics {.numbered}
...
### Intermediate representation (IR) {.numbered}
...
#### Pipeline node representation {.numbered}
...
#### Pipeline representation {.numbered}
...
### Workflows, scenarios and examples {.numbered}
...
##### Asynchronous execution pipeline mode {.numbered}
...
###### Using synchronous and asynchronous inputs in a sub-pipeline {.numbered}
...
###### Consuming synchronous and asynchronous outputs of a sub-pipeline {.numbered}
