#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_ENV_TIME_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_ENV_TIME_H_
...
#endif  //  TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_ENV_TIME_H_
