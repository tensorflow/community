#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_NUMERIC_TYPES_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_NUMERIC_TYPES_H_
...
namespace Eigen {
template <>
struct NumTraits<intel_plugin::tstring>
    : GenericNumTraits<intel_plugin::tstring> {
  enum {
 ...
 private:
  static inline intel_plugin::tstring epsilon();
  static inline intel_plugin::tstring dummy_precision();
  static inline intel_plugin::tstring lowest();
  static inline intel_plugin::tstring highest();
  static inline intel_plugin::tstring infinity();
  static inline intel_plugin::tstring quiet_NaN();
};
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_NUMERIC_TYPES_H_
