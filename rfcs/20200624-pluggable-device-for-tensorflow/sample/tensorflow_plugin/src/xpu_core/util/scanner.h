#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_SCANNER_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_SCANNER_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_SCANNER_H_
