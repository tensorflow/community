#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_CTSTRING_INTERNAL_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_CTSTRING_INTERNAL_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_UTIL_CTSTRING_INTERNAL_H_
