#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TENSOR_TYPES_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TENSOR_TYPES_H_
...
//}  // namespace intel_plugin
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TENSOR_TYPES_H_
