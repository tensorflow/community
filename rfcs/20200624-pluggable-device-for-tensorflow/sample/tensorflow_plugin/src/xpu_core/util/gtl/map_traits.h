...
#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_GTL_MAP_TRAITS_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_GTL_MAP_TRAITS_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_GTL_MAP_TRAITS_H_
