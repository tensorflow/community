#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_PROTOBUF_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_PROTOBUF_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_PROTOBUF_H_
