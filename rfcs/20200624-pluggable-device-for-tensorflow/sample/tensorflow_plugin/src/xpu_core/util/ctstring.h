#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_CTSTRING_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_CTSTRING_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_CTSTRING_H_
