...
//
#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_STRCAT_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_STRCAT_H_

#include <string>

#include "tensorflow_plugin/src/xpu_core/util/macros.h"
#include "tensorflow_plugin/src/xpu_core/util/numbers.h"
...
class AlphaNum {
 public:
  ...
  AlphaNum(const intel_plugin::string& str)        // NOLINT(runtime/explicit)
      : piece_(str) {}
  AlphaNum(const intel_plugin::tstring& str)  // NOLINT(runtime/explicit)
      : piece_(str) {}
  template <typename A>
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_STRCAT_H_
