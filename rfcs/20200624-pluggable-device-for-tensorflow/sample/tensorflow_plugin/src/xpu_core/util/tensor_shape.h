#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TENSOR_SHAPE_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TENSOR_SHAPE_H_
...
using intel_plugin::TensorShapeProto;
// END_SKIP_DOXYGEN
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TENSOR_SHAPE_H_
