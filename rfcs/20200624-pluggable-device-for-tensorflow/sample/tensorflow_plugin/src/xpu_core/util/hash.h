#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_HASH_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_HASH_H_
...
using StringPieceHasher = ::intel_plugin::hash<StringPiece>;
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_HASH_H_
