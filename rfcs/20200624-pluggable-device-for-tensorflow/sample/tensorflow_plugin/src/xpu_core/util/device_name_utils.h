#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_DEVICE_NAME_UTILS_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_DEVICE_NAME_UTILS_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_DEVICE_NAME_UTILS_H_
