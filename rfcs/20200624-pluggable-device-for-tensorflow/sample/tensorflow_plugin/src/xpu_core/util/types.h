#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TYPES_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TYPES_H_
...
struct EnumToDataType<DT_INT64> {
  typedef intel_plugin::int64 Type;
};
...
struct EnumToDataType<DT_UINT64> {
  typedef intel_plugin::uint64 Type;
};
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TYPES_H_
