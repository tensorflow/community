#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TSTRING_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TSTRING_H_
...
#include "tensorflow_plugin/src/xpu_core/util/ctstring.h"
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TSTRING_H_
