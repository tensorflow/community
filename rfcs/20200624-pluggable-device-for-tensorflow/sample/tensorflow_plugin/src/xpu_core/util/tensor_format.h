#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TENSOR_FORMAT_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TENSOR_FORMAT_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_UTIL_TENSOR_FORMAT_H_
