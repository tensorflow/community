#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_GRAPH_UTILS_OP_TYPES_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_GRAPH_UTILS_OP_TYPES_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_GRAPH_UTILS_OP_TYPES_H_
