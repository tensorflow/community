#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_KERNELS_GPU_SOFTMAX_OP_FUNCTOR_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_KERNELS_GPU_SOFTMAX_OP_FUNCTOR_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_KERNELS_GPU_SOFTMAX_OP_FUNCTOR_H_
