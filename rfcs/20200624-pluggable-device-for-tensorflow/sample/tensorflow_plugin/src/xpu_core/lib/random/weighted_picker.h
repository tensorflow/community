...
#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_LIB_RANDOM_WEIGHTED_PICKER_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_LIB_RANDOM_WEIGHTED_PICKER_H_

#include <assert.h>

#include "tensorflow_plugin/src/util//macros.h"
#include "tensorflow_plugin/src/util/logging.h"
#include "tensorflow_plugin/src/util/types.h"
