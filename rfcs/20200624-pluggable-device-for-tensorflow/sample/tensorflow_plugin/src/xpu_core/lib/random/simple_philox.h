#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_LIB_RANDOM_SIMPLE_PHILOX_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_LIB_RANDOM_SIMPLE_PHILOX_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_LIB_RANDOM_SIMPLE_PHILOX_H_
