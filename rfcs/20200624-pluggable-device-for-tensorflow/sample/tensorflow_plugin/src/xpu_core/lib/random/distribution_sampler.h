...
#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_LIB_RANDOM_DISTRIBUTION_SAMPLER_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_LIB_RANDOM_DISTRIBUTION_SAMPLER_H_

#include <memory>
#include <utility>

#include "tensorflow_plugin/src/xpu_core/lib/random/simple_philox.h"
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_LIB_RANDOM_DISTRIBUTION_SAMPLER_H_
