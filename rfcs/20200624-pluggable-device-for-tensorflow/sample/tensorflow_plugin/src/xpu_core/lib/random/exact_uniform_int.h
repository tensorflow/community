...
#ifndef TENSORFLOW_PLUGIN_SRC_XPU_CORE_LIB_RANDOM_EXACT_UNIFORM_H_
#define TENSORFLOW_PLUGIN_SRC_XPU_CORE_LIB_RANDOM_EXACT_UNIFORM_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_XPU_CORE_LIB_RANDOM_EXACT_UNIFORM_H_
