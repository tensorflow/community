#ifndef TENSORFLOW_PLUGIN_SRC_UTILS_MACROS_H_
#define TENSORFLOW_PLUGIN_SRC_UTILS_MACROS_H_
...
namespace internal {
template <typename T> void remove_unused_variable_compiler_warning(const T &){};
}
} // namespace demo_plugin
#define TF_UNUSED_VARIABLE(x)                                                  \
  tensorflow::internal::remove_unused_variable_compiler_warning(x)

#endif // TENSORFLOW_PLUGIN_SRC_UTILS_MACROS_H_
