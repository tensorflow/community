#ifndef TENSORFLOW_PLUGIN_SRC_UTILS_CTSTRING_INTERNAL_H_
#define TENSORFLOW_PLUGIN_SRC_UTILS_CTSTRING_INTERNAL_H_
...
#endif // TENSORFLOW_PLUGIN_SRC_UTILS_CTSTRING_INTERNAL_H_
