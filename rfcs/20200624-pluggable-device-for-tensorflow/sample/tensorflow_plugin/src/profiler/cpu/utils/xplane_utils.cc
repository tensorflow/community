...
#include "tensorflow_plugin/src/utils/logging.h"
#include "tensorflow_plugin/src/utils/protobuf.h"
...
#include "tensorflow_plugin/src/profiler/cpu/utils/timespan.h"
#include "tensorflow_plugin/src/profiler/cpu/utils/xplane_builder.h"
#include "tensorflow_plugin/src/profiler/cpu/utils/xplane_visitor.h"
...
void MergePlanes(const XPlane& src_plane, XPlane* dst_plane) {
  ...
  src.ForEachStat([&](const demo_plugin::profiler::XStatVisitor& stat) {
  ...
  src.ForEachLine([&](const demo_plugin::profiler::XLineVisitor& line) {
    ...
    line.ForEachEvent([&](const demo_plugin::profiler::XEventVisitor& event) {
      ...
      event.ForEachStat([&](const demo_plugin::profiler::XStatVisitor& stat) {
