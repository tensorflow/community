...
#ifndef TENSORFLOW_PLUGIN_SRC_PROFILER_CPU_UTILS_TIME_UTILS_H_
#define TENSORFLOW_PLUGIN_SRC_PROFILER_CPU_UTILS_TIME_UTILS_H_
...
#endif  // TENSORFLOW_PLUGIN_SRC_PROFILER_CPU_UTILS_TIME_UTILS_H_
