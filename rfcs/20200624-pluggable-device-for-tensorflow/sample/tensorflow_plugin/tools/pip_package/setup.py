...
# result for pip.
# Also update tensorflow/intel_plugin.bzl and
...
if os.name == 'nt':
  EXTENSION_NAME = 'libintel_plugin.pyd'
else:
  EXTENSION_NAME = 'libintel_plugin.so'
...
setup(
    ...
    long_description='\n'.join(DOCLINES[2:]),
    url='https://gitlab.devtools.intel.com/tf/tensorflow-plugin',
    download_url='https://gitlab.devtools.intel.com/tf/tensorflow-plugin',
    author='INTEL MLP Tensorflow SH',
