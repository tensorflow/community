...
The type system listed here can be expanded to allow input signatures using type annotations, see for instance [`](https://github.com/tensorflow/tensorflow/issues/31579).
